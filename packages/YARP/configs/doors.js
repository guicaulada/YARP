...
let singlePosition = {
  ...
  'Popular LSC': {
    model: 868499217,
    position: new mp.Vector3(82.38156, -1390.752, 29.52609),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Carcer LSC': {
    model: 270330101,
    position: new mp.Vector3(723.116, -1088.831, 23.23201),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Ammu-Nation Office': {
    model: 452874391,
    position: new mp.Vector3(6.81789, -1098.209, 29.94685),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Franklin House': {
    model: 520341586,
    position: new mp.Vector3(-14.86892, -1441.182, 31.19323),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Franklin House Garage': {
    model: 703855057,
    position: new mp.Vector3(-25.2784, -1431.061, 30.83955),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Mission Row Cells': {
    model: -1033001619,
    position: new mp.Vector3(463.4782, -1003.538, 25.00599),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Mission Row Capitan': {
    model: -1320876379,
    position: new mp.Vector3(446.5728, -980.0106, 30.8393),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Mission Row Lockers': {
    model: 1557126584,
    position: new mp.Vector3(450.1041, -985.7384, 30.8393),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Mission Row Roof': {
    model: -340230128,
    position: new mp.Vector3(464.3613, -984.678, 43.83443),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Mission Row Gate': {
    model: -1603817716,
    position: new mp.Vector3(488.8923, -1011.67, 27.14583),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Vanilla Unicorn Main': {
    model: -1116041313,
    position: new mp.Vector3(127.9552, -1298.503, 29.41962),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Vanilla Unicorn Back': {
    model: 668467214,
    position: new mp.Vector3(96.09197, -1284.854, 29.43878),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Vanilla Unicorn Office': {
    model: -626684119,
    position: new mp.Vector3(99.08321, -1293.701, 29.41868),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Vanilla Unicorn Dress': {
    model: -495720969,
    position: new mp.Vector3(113.9822, -1297.43, 29.41868),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
  ...
  'Vanilla Unicorn Private': {
    model: -1881825907,
    position: new mp.Vector3(116.0046, -1294.692, 29.41947),
    enter: (player) => {
      this.open();
    },
    leave: (player) => {
...
for (let id in singlePosition) {
  if (singlePosition.hasOwnProperty(id)) {
    let door = singlePosition[id];
    config[id] = {
      model: door.model,
...
for (let id in multiplePositions) {
  if (multiplePositions.hasOwnProperty(id)) {
    let door = multiplePositions[id];
    door.position.forEach((position, i) => {
      config[id + ' ' + i] = {
        model: door.model,
        position: position,
        enter: door.enter,
