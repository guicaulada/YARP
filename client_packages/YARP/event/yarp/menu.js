...
mp.events.add('showAmmuMenu', (file, id, store, weaponsJson) => {
	mp.events.call('createBrowser', "menu", ['package://YARP/ui/html/sideMenu.html', 'populateAmmuWeapons', file, id, store, weaponsJson]);
});
...
mp.events.add('showSelectorMenu', (file, id, selector, optionsJson) => {
	mp.events.call('createBrowser', "menu", ['package://YARP/ui/html/sideMenu.html', 'populateSelectorOptions', file, id, selector, optionsJson]);
});
