...
$("div#sex").on("click", "img", function() {
	if($(this).hasClass("enabled") == false) {
		...
		mp.trigger('yarp_updatePlayerSex', currentModel);
	}
});
...
function createCharacter() {
	if($.trim($('#character-name').val()).length == 0) {
		...
		mp.trigger('yarp_acceptCharacterCreation', characterName.trim() + " " + characterSurname.trim(), characterAge, currentModel);
	}
}

function cancelCreation() {
	// Cancelamos la creación del personaje
	mp.trigger('yarp_cancelCharacterCreation');
}
...
function showPrevHairModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'hairModel', currentHairModel, false);
}
...
function showPrevHairFirstColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'firstHairColor', currentHairFirstColor, false);
}
...
function showPrevHairSecondColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'secondHairColor', currentHairSecondColor, false);
}
...
function showPrevBeardModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'beardModel', currentBeardModel, false);
}
...
function showPrevBeardColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'beardColor', currentBeardColor, false);
}
...
function showPrevChestModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'chestModel', currentChestModel, false);
}
...
function showPrevChestColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'chestColor', currentChestColor, false);
}
...
function showPrevBlemishesModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'blemishesModel', currentBlemishesModel, false);
}
...
function showPrevAgeingModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'ageingModel', currentAgeingModel, false);
}
...
function showPrevComplexionModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'complexionModel', currentComplexionModel, false);
}
...
function showPrevSundamageModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'sundamageModel', currentSundamageModel, false);
}
...
function showPrevFrecklesModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'frecklesModel', currentFrecklesModel, false);
}
...
function showPrevEyesColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'eyesColor', currentEyesColor, false);
}
...
function showPrevEyebrowsModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'eyebrowsModel', currentEyebrowsModel, false);
}
...
function showPrevEyebrowsColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'eyebrowsColor', currentEyebrowsColor, false);
}
...
function updateA() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'noseWidth', aValue, true);
}

function updateB() {
	let bValue = document.getElementById('b').value;
	mp.trigger('yarp_updatePlayerCreation', 'noseHeight', bValue, true);
}

function updateC() {
	let bValue = document.getElementById('c').value;
	mp.trigger('yarp_updatePlayerCreation', 'noseLength', bValue, true);
}

function updateD() {
	let bValue = document.getElementById('d').value;
	mp.trigger('yarp_updatePlayerCreation', 'noseBridge', bValue, true);
}

function updateE() {
	let bValue = document.getElementById('e').value;
	mp.trigger('yarp_updatePlayerCreation', 'noseTip', bValue, true);
}

function updateF() {
	let bValue = document.getElementById('f').value;
	mp.trigger('yarp_updatePlayerCreation', 'noseShift', bValue, true);
}

function updateG() {
	let bValue = document.getElementById('g').value;
	mp.trigger('yarp_updatePlayerCreation', 'browHeight', bValue, true);
}

function updateH() {
	let bValue = document.getElementById('h').value;
	mp.trigger('yarp_updatePlayerCreation', 'browWidth', bValue, true);
}

function updateI() {
	let bValue = document.getElementById('i').value;
	mp.trigger('yarp_updatePlayerCreation', 'cheekboneHeight', bValue, true);
}

function updateJ() {
	let bValue = document.getElementById('j').value;
	mp.trigger('yarp_updatePlayerCreation', 'cheekboneWidth', bValue, true);
}

function updateK() {
	let bValue = document.getElementById('k').value;
	mp.trigger('yarp_updatePlayerCreation', 'cheeksWidth', bValue, true);
}

function updateL() {
	let bValue = document.getElementById('l').value;
	mp.trigger('yarp_updatePlayerCreation', 'eyes', bValue, true);
}

function updateM() {
	let bValue = document.getElementById('m').value;
	mp.trigger('yarp_updatePlayerCreation', 'lips', bValue, true);
}

function updateN() {
	let bValue = document.getElementById('n').value;
	mp.trigger('yarp_updatePlayerCreation', 'jawWidth', bValue, true);
}

function updateO() {
	let bValue = document.getElementById('o').value;
	mp.trigger('yarp_updatePlayerCreation', 'jawHeight', bValue, true);
}

function updateP() {
	let bValue = document.getElementById('p').value;
	mp.trigger('yarp_updatePlayerCreation', 'chinLength', bValue, true);
}

function updateQ() {
	let bValue = document.getElementById('q').value;
	mp.trigger('yarp_updatePlayerCreation', 'chinPosition', bValue, true);
}

function updateR() {
	let bValue = document.getElementById('r').value;
	mp.trigger('yarp_updatePlayerCreation', 'chinWidth', bValue, true);
}

function updateS() {
	let bValue = document.getElementById('s').value;
	mp.trigger('yarp_updatePlayerCreation', 'chinShape', bValue, true);
}

function updateT() {
	let bValue = document.getElementById('t').value;
	mp.trigger('yarp_updatePlayerCreation', 'neckWidth', bValue, true);
}
...
function showPrevMakeupModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'makeupModel', currentMakeupModel, false);
}
...
function showPrevBlushModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'blushModel', currentBlushModel, false);
}
...
function showPrevBlushColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'blushColor', currentBlushColor, false);
}
...
function showPrevLipstickModel() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'lipstickModel', currentLipstickModel, false);
}
...
function showPrevLipstickColor() {
	...
	mp.trigger('yarp_updatePlayerCreation', 'lipstickColor', currentLipstickColor, false);
}
