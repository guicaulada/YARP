...
// Credits to kamperr
exports.getWeaponTypeInSlot = function(weaponSlot){
...
exports.setWeaponAmmo = function(weaponhash, ammo){
...
exports.giveWeaponComponent = function(weaponhash, component){
  return mp.game.invoke('0xAD084726D7F23594', mp.players.local.handle, weaponhash, component);
}

exports.getWeaponClipSize = function(weaponhash){
